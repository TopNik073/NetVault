...
from src.exceptions import BaseServerError
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        try:
            ...
            return JSONResponse(
                ...
                content={"detail": e.detail, "code": getattr(e, "code", None)}
            )

        except BaseServerError as e:
            await self.create_final_log('failed', request, context, start_time, e.http_code, e)
            return JSONResponse(
